...
/**
 * A rectangle shape, defined by its position and size, particularly useful in
 * collision detection.
 */
public class Rectangle {
    ...
    /**
     * Set rectangle data. Used to update game entities that move and/or change
     * size.
     *
     * @param left x-coordinate of top-left corner (left edge) of rectangle
     * @param top y-coordinate of top-left corner (top edge) of rectangle
    ...
    /**
     * Update rectangle data. Used for game entities that move.
     *
     * @param left x-coordinate of top-left corner (left edge) of rectangle
     * @param top y-coordinate of top-left corner (top edge) of rectangle
     */
