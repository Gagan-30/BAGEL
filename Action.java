...
public class Action {
    ...
    public static Action delayFadeRemove(double delayTime, double fadeTime) {
        return Action.sequence(Action.delay(delayTime), Action.fadeOut(fadeTime), Action.removeSelf());
    }

    public static Action animateThenRemove() {
        return Action.sequence(Action.isAnimationFinished(), Action.removeSelf());
    }
}
