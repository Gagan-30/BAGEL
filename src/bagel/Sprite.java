...
public class Sprite extends Entity {
    ...
    /**
     * amount of transparency; value from 0.0 (fully transparent) to 1.0 (fully
     * opaque)
     */
    ...
    /**
     * set the texture data used when drawing this sprite; also sets width and
     * height of sprite
     *
    ...
    /**
     * set the width and height of this sprite; used for drawing texture and
     * collision rectangle
     *
    ...
    /**
     * Get boundary shape for this sprite, adjusted according to current
     * position. Angle of rotation has no effect on the boundary.
     *
    ...
    /**
     * Prevent this sprite from overlapping another sprite by adjusting the
