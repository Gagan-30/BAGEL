...
/**
 * Used to simulate change in position of an object based on velocity and
 * acceleration; useful in games with a top-down view perspective.
 */
public class Physics {
    ...
    /**
     * Initialize values used by physics simulation. For objects travelling at
     * constant speed, set acceleration and deceleration values to 0.
     *
    ...
    /**
     * Set speed of object. If acceleration and deceleration values are 0, the
    ...
    /**
     * Calculate the angle of motion (in degrees) as measured from the x-axis
     * (the vector (1,0)). If the speed is 0, this method returns 0. Return
     * values are in the range from -180 to +180.
     *
    ...
    /**
     * Set the angle of motion of this object. If the speed is 0, this method
     * has no effect.
     *
    ...
    /**
     * Accelerate this object in the direction angleDegrees by the amount
     * specified by {@link #accelerationValue}.
     *
    ...
    /**
     * Update the position of this object according to velocity and
     * acceleration. Deceleration is applied if no acceleration is present.
     *
