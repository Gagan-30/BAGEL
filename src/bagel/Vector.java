...
public class Vector implements Comparable<Vector> {
    ...
    /**
     * Add the values of the coordinates of other vector to the coordinates of
     * this vector.
     *
    ...
    /**
     * Calculate the angle (in degrees) between this vector and the x-axis (the
     * vector (1,0)). If this vector is the zero vector, returns 0. Return
    ...
    /**
     * Changes the length of this vector to length while preserving the angle of
     * this vector.
     *
    ...
    /**
     * Changes the angle of this vector to angleDegrees while preserving the
     * length of this vector.
     *
     * @param angleDeg the new angle (in degrees) between this vector and the
     * x-axis
     */
